# ✈️ Air Attack - Aerial Combat Game
...
|-----------|---------|-------------|
| OS | Windows Only | Windows 10/11 |
| RAM | 2 GB | 6 GB |
| Processor | 0.79 GHz | 2.0 GHz |
...
- **Base Kill** - Points based on enemy type
- **Combo Multiplier** - Up to 10x based on consecutive kills
- **Accuracy Bonus** - Based on hit percentage
- **Survival Bonus** - Based on remaining health
- **Level Completion Bonus** - All bonuses combined

## 👨‍💻 Credits

**Developed by:** M. Dallen Shelly  
**Contact:** dallenshelly@proton.me
...
For issues, questions, or feedback, contact: **dallenshelly@proton.me**
